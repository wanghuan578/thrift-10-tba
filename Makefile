...
ACLOCAL = ${SHELL} /home/thrift-0.10.0/missing aclocal-1.13
ALLOCA = 
AMTAR = $${TAR-tar}
...
ANT_FLAGS = 
AR = ar
AUTOCONF = ${SHELL} /home/thrift-0.10.0/missing autoconf
AUTOHEADER = ${SHELL} /home/thrift-0.10.0/missing autoheader
AUTOMAKE = ${SHELL} /home/thrift-0.10.0/missing automake-1.13
AWK = gawk
BISON = bison
BOOST_CHRONO_LDADD = /usr/local/lib64/libboost_chrono.a
BOOST_CPPFLAGS = -I/usr/local/include
BOOST_FILESYSTEM_LDADD = /usr/local/lib64/libboost_filesystem.a
BOOST_LDFLAGS = -L/usr/local/lib64
BOOST_LIB_DIR = /usr/local/lib64
BOOST_SYSTEM_LDADD = /usr/local/lib64/libboost_system.a
BOOST_TEST_LDADD = /usr/local/lib64/libboost_unit_test_framework.a
BOOST_THREAD_LDADD = /usr/local/lib64/libboost_thread.a
BUNDLER = 
CABAL = true
...
LUA_SHORT_VERSION = 
LUA_VERSION = 
MAKEINFO = ${SHELL} /home/thrift-0.10.0/missing makeinfo
MANIFEST_TOOL = :
MAYBE_CPP = cpp
MAYBE_CSHARP = 
MAYBE_C_GLIB = 
...
ZLIB_LDFLAGS = 
ZLIB_LIBS = -lz
abs_builddir = /home/thrift-0.10.0
abs_srcdir = /home/thrift-0.10.0
abs_top_builddir = /home/thrift-0.10.0
abs_top_srcdir = /home/thrift-0.10.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/thrift-0.10.0/install-sh
...
lib/cpp/src/thrift/config.h: lib/cpp/src/thrift/stamp-h2
	@if test ! -f $@; then rm -f lib/cpp/src/thrift/stamp-h2; else :; fi
	@if test ! -f $@; then $(MAKE) $(AM_MAKEFLAGS) lib/cpp/src/thrift/stamp-h2; else :; fi
...
lib/c_glib/src/thrift/config.h: lib/c_glib/src/thrift/stamp-h3
	@if test ! -f $@; then rm -f lib/c_glib/src/thrift/stamp-h3; else :; fi
	@if test ! -f $@; then $(MAKE) $(AM_MAKEFLAGS) lib/c_glib/src/thrift/stamp-h3; else :; fi
